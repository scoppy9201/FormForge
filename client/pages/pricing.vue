          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="mt-1 text-base font-medium leading-7 text-yellow-600">
                Whether your nonprofit is large or small, CRMGO's online Form
      ...
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          <div
            v-for="q in [
              {
                question: 'Is there a free version of CRMGO available?',
                answer:
                  'Yes, CRMGO offers a free version with access to 99% of features, including unlimited forms, submissions, fields, webhooks, API access tokens, and more. Our goal is to provide robust functionality for all users without limitations.',
              },
              {
                question: 'What does the Pro Plan include?',
                answer:
                  'The CRMGO Pro Plan is designed to meet the advanced needs of teams and creators. It includes features like form confirmation emails, Slack and Discord notifications, editable submissions, custom domain, custom code integration, larger file uploads, removal of CRMGO branding, priority support, and more.',
              },
              {
              ...
              },
              {
                ...
                answer:
                  'CRMGO is committed to supporting nonprofits and students. We provide an exclusive 50% discount on the Pro Plan for nonprofit organizations and students. This discount helps you make the most of our form builder while staying within your budget.',
              },
              {
                question: 'Can I cancel or change my plan at any time?',
                answer:
                  'Yes, you have the flexibility to upgrade, downgrade, or cancel your CRMGO Pro Plan at any time. Changes will take effect immediately, and you\'ll only be billed based on the plan you\'re currently on.',
              },
            ]"
            :key="q.question"
          >
...
export default {
  ...
  setup() {
    useOpnSeoMeta({
      title: "Pricing",
      description:
        "All of our core features are free, and there is no quantity limit. You can also created more advanced and customized forms with CRMGOs Pro.",
    })
